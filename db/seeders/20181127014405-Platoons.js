    ...
    return queryInterface.bulkInsert('platoons', [
      {
        ...
        no_of_member: 4,
        description: "Contains high quality beef also with less fat, it has a highly developed and dilated internal organs than most breed, it produces a higher amount of offal :large intestine(Shaki), small intestine(Abodi),liver (Edo) etc. An average 380kg of this breed can produce up to 4560 pieces of meet",
      ...
      },
      {
        ...
        no_of_member: 4,
        description: "Grows faster when well nourished. They are temperamental in nature, can be nervous and stubborn. They have long horns, large hump and can withstand arid weather conditions. <br> Contains high quality lean Beef with less fat, it produces more beef than other breeds, beef from this breed is hard and require more cooking time. Its Meat tend to become Bigger after cooking, an average 450kg of this breed can produce up to 5400 pieces of meat",
